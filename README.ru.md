...
> ℹ️ **Сетевой цикл:** Ввод осуществляется на основе транзакций. Клиент отправляет одну полезную нагрузку сети только тогда, когда пользователь нажимает клавишу `Enter`, вместо потоковой передачи каждого нажатия клавиши.
